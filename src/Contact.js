    ...
    render() {
        return (
            <>
                    ...
                    <div className="w3-row w3-padding-32">
                        ...
                        <div className="w3-col m6">
                            <form>
                                ...
                                <button className="w3-button  mt- 3 w3-black w3-section w3-right" type="submit">SEND</button>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <img src={require("./accet/map.jpg")} className="w3-image w3-greyscale-min" alt='uu' style={{ width: "100%" }} />
